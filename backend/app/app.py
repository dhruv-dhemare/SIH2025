...
def extract_quick_fields(text: str):
    ...
    return {
        "emails": emails, "phones": phones, "names": names, "orgs": orgs,
        "locations": locations, "education": edu_matches, "skills": skills_matches,
        "projects": project_matches, "experience": ["{} {} {}".format(*exp).strip() for exp in experience_matches if any(exp)],
